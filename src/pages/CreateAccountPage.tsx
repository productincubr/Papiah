...
export default function CreateAccountPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await register(formData.email, formData.password, firstName, lastName);
    setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-[#1C1B19] font-sans flex items-center justify-center p-6 md:p-12 lg:p-24 relative overflow-hidden paper-texture selection:bg-[#EAD9FA] selection:text-[#1C1B19]">
      ...
      {/* Two-column layout grid, items-start to align left content exactly with register card top */}
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start relative z-10 mt-16 lg:mt-8">
        
        {/* Left Column - Marketing & Brand Info */}
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <div className="flex flex-col gap-0.5">
                <h3 className="font-serif text-[15.5px] font-medium text-[#1C1B19] leading-tight">Faster Checkout</h3>
                <p className="text-[12px] text-gray-500 font-sans font-light leading-relaxed max-w-[320px]">
                  Save your details for a seamless shopping experience.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <div className="flex flex-col gap-0.5">
                <h3 className="font-serif text-[15.5px] font-medium text-[#1C1B19] leading-tight">Your Favorites</h3>
                <p className="text-[12px] text-gray-500 font-sans font-light leading-relaxed max-w-[320px]">
            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <div className="flex flex-col gap-0.5">
                <h3 className="font-serif text-[15.5px] font-medium text-[#1C1B19] leading-tight">Stay Inspired</h3>
                <p className="text-[12px] text-gray-500 font-sans font-light leading-relaxed max-w-[320px]">
        ...
        <div className="flex justify-center lg:justify-start w-full">
          <div className="w-full max-w-[480px] bg-white rounded-[2rem] p-8 md:p-10 border border-[#FAF9F6] shadow-[0_12px_48px_rgba(28,27,25,0.04)]">
            ...
            <div className="mb-8 text-center lg:text-left">
              <h2 className="font-serif text-3xl text-[#1C1B19] mb-2 tracking-tight">Create Account</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5 text-left">
                <label htmlFor="fullName" className="text-[11px] font-bold tracking-wider text-[#1C1B19]/60 uppercase block">
                  Full name
                </label>
              ...
              {/* Confirm Password */}
              <div className="space-y-1.5 text-left">
                <label htmlFor="confirmPassword" className="text-[11px] font-bold tracking-wider text-[#1C1B19]/60 uppercase block">
                  Confirm password
                </label>
                <div className="relative">
                  <input
              ...
              <div className="flex items-start gap-3 pt-2 text-left">
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-4.5 h-4.5 rounded border-gray-300 text-[#8E76B8] focus:ring-[#8E76B8] cursor-pointer mt-0.5"
                />
                <label htmlFor="agreeTerms" className="text-xs text-[#1C1B19]/75 select-none cursor-pointer leading-relaxed">
                  I agree to the{" "}
